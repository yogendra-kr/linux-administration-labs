...
- Created a Proxmox snapshot before system changes
  ...
  ![snapshot](../assets/screenshots/ubuntu-server-commissioning-02-pve-snapshot.png)
...
- Reviewed SSH server configuration.
  ...
  ![SSH server configuration](../assets/screenshots/ubuntu-server-commissioning-03-sshd-config.png)
...
- Verified firewall status.
  ...
  ![firewall status](../assets/screenshots/ubuntu-server-commissioning-04-ufw-rules.png)
